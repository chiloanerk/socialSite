        ...
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form class="space-y-6" action="/register" method="POST">
                    <div>
                        <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Username/Handle</label>
                        <div class="mt-2">
                            <input id="username" name="username" type="text" value="<?= isset($values['username']) ? htmlspecialchars($values['username']) : '' ?>" autocomplete="username" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            ...
                            <?php if (isset($errors['password_confirmation'])) : ?>
                                <p class="text-red-500 text-xs mt-2"><?= $errors['password_confirmation'] ?></p>
                            <?php endif; ?>
